 ...
 */
@property(nonatomic, weak, nullable) IBOutlet id<KPCTabsControlDataSource> dataSource;

/**
 *  The delegate of the tabs control, providing additional possibilities for customization and precise behavior.
 */
@property(nonatomic, weak, nullable) IBOutlet id <KPCTabsControlDelegate> delegate;
 ...
 */
@property(nonatomic, weak, nullable) id selectedItem;
